...
The ROMs that are provided for this controller are different only in Nextor version. There's Alpha and Beta versions of the ROM
available as well. We recommend to use the Beta 2 version for your device. So please write the Beta ROM BIOS into the EEPROM chip.
